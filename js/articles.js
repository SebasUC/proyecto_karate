const articles = [
    {
        ...
        thumbnail: "./assets/blog/posts/1.png",
        content: [
            {
...
29 de abril
    ...
    {
        id: 2,
        title: "Examenes de cinta",
        thumbnail: "./assets/blog/posts/2.png",
        content: [
            {
                title: "Cambio de cintas más reciente",
                image: "./assets/blog/articles/article2/1.png",
                description: [
                    {
                        subtitle: "Examen de Cambio de Cintas de Medio Año en la Academia Fudoshin de Karate",
                        paragraph: "El pasado fin de semana, nuestra querida academia Fudoshin de Karate celebró el esperado examen de cambio de cintas de medio año. Este evento, que reúne a todos los alumnos y maestros de la academia, es uno de los momentos más importantes en el calendario anual de Fudoshin, ya que simboliza el progreso y el esfuerzo constante de nuestros karatekas."
                    },
                    {
                        subtitle: "Organización del Evento",
                        paragraph: 
`El examen fue meticulosamente organizado para asegurar que cada detalle reflejara la seriedad y el respeto hacia el arte del Karate. La jornada comenzó temprano en la mañana, con la llegada de los alumnos y sus familias, quienes vinieron a apoyar y ser testigos de los avances de sus seres queridos.
...
3 de junio
            ...
            },
            {
                ...
                image: "./assets/blog/articles/article2/2.png",
                description: [
                    {
                        subtitle: "Felicitaciones a los Estudiantes de la Academia Fudoshin de Karate",
                        paragraph: "Nos enorgullece enormemente felicitarles por su desempeño excepcional en el reciente examen de cambio de cintas de medio año. Este evento no solo es una prueba de sus habilidades y técnicas, sino también un reflejo de su arduo trabajo, dedicación y espíritu inquebrantable."
                    },
                    {
                        subtitle: "Hitos Destacados",
                        paragraph: 
`🥋Tomás Quesada: Por su destacada ejecución en kata y kumite, demostrando un control impecable y una fuerza admirable.
🥋Ailyn Quesada: Por su habilidad y precisión en cada técnica, logrando excelentes resultados en ambas disciplinas.
🥋Rebeca López, Yeilin Monge, Nefher Menocal, y María Fernanda Mendoza: Por su notable desempeño y dedicación, cada uno de ustedes ha mostrado una gran mejora y un espíritu guerrero que inspira a todos.
                    `
                    },
                    {
                        subtitle: "¡Felicitaciones a todos!",
                        paragraph: `
Nos sentimos honrados de tenerlos como parte de la familia Fudoshin. Su progreso es un testimonio del esfuerzo colectivo y del espíritu indomable que caracteriza a nuestra academia. Sigan adelante con la misma energía y dedicación, sabiendo que cada paso que dan los acerca más a la excelencia.

¡Osu!

Con gratitud y orgullo,

Sensei Sergio Cambronero y el equipo de la Academia Fudoshin de Karate
...
3 de junio`
    ...
    },
    {
        ...
        thumbnail: "./assets/blog/posts/3.png",
        content: [
            {
                title: "Los Entrenamientos de esta Semana en la Academia Fudoshin de Karate",
                image: "./assets/blog/articles/article3/1.png",
                description: [
                    {
                        subtitle: "Lunes: Fundamentos y Técnica",
                        paragraph: "Comenzamos la semana con un enfoque en los fundamentos y la técnica. Sensei Sergio Cambronero dirigió una sesión intensa de kihon, donde los alumnos practicaron las técnicas básicas de puñetazos, patadas y bloqueos. El énfasis estuvo en la precisión y la correcta ejecución de cada movimiento, asegurando que los fundamentos estén sólidos."
                    },
                    {
                        subtitle: "Martes: Kata y Perfeccionamiento",
                        paragraph:'El martes fue dedicado a la práctica de kata. Los alumnos repasaron y perfeccionaron sus katas correspondientes, con especial atención a la fluidez y la correcta aplicación de las técnicas. Sensei Cambronero y los instructores ayudaron a cada estudiante a pulir detalles específicos, destacando la importancia de la concentración y la conexión entre mente y cuerpo.'
                    },
                    {
                        subtitle: "Miércoles: Kumite y Estrategia",
                        paragraph:'A mitad de semana, el enfoque se trasladó al kumite. Los estudiantes participaron en combates controlados, donde aplicaron las técnicas aprendidas en situaciones reales. La sesión se centró en la estrategia y la toma de decisiones rápidas, enseñando a los karatekas a anticipar los movimientos de sus oponentes y responder con eficacia.'
                    },
                ]
            },
            {
                title: "Reflexiones de la Semana",
                image: "./assets/blog/articles/article3/2.png",
                description: [
                    {
                        subtitle: "Tomás Quesada:",
                        paragraph: "Esta semana me he sentido más fuerte y seguro en mis técnicas. Los entrenamientos han sido desafiantes, pero sé que estoy mejorando cada día."
                    },
                    {
                        subtitle: "Ailyn Quesada:",
                        paragraph:'Me encanta practicar kata. Cada movimiento se siente más natural y preciso. Estoy agradecida por los comentarios de Sensei Cambronero, que me ayudan a ser mejor.'
                    },
                    {
                        subtitle: "Rebeca López:",
                        paragraph:'El kumite ha sido increíble esta semana. Aprender a anticipar los movimientos de mis compañeros me ha dado más confianza en los combates.'
                    },
                ]
            },
            {
                title: "Mirando Hacia Adelante",
                image: "./assets/blog/articles/article3/3.png",
                description: [
                    {
                        subtitle: "Enfoque",
                        paragraph: `
Con la misma energía y determinación, esperamos el resto de la semana de entrenamientos. Sigamos trabajando duro, superando nuestros límites y avanzando juntos en nuestro viaje marcial.
...
¡Osu!`
    ...
    },
    {
        ...
        thumbnail: "./assets/blog/posts/4.png",
        content: [
            {
                title: "Apoyo a Nuestros Atletas en la Selección Nacional",
                image: "./assets/blog/articles/article4/1.png",
                description: [
                    {
                        subtitle: "Reconocimiento y Orgullo",
                        paragraph: "Ser parte de la selección nacional es un honor y una responsabilidad enormes. Nuestros atletas han trabajado incansablemente, demostrando una y otra vez su compromiso con los valores del Karate y su habilidad excepcional en cada técnica, kata y combate. Su perseverancia y determinación no solo los han llevado a alcanzar este nivel, sino que también inspiran a toda nuestra comunidad."
                    },
                    {
                        subtitle: "Apoyo Incondicional",
                        paragraph: 
`Sabemos que representar a la selección nacional implica enfrentar grandes retos y sacrificios. Desde la Academia Fudoshin, queremos que nuestros atletas sepan que cuentan con todo nuestro apoyo incondicional. Cada paso que den, cada entrenamiento y cada competencia son seguidos de cerca por nosotros con el mayor de los orgullos.
...
25 de junio
            ...
            {
                title: "¡Adelante, Guerreros!",
                image: "./assets/blog/articles/article4/2.png",
                description: [
                    {
                        subtitle: "Mensaje de aliento",
                        paragraph: `Lleven consigo el espíritu indomable de Fudoshin en cada enfrentamiento, y recuerden que siempre estaremos aquí, orgullosos de sus logros y listos para apoyarles en todo momento. ¡Osu!

Con admiración y respeto,

Sensei Sergio Cambronero y toda la Academia Fudoshin de Karate`
                    }
                ]
            },
        ]
    ...
    {
        id: 6,
        title: "Clases de Ejercicios Funcionales",
